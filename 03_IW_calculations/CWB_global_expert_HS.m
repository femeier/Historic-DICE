...
CWB_global_expertbased=[share_meanCWBCO2gross, share_meanCWBCO2grossepo1,share_meanCWBCO2grossepo2,share_meanCWBCO2grossepo3;
    share_stdCWBCO2gross, share_stdCWBCO2grossepo1,share_stdCWBCO2grossepo2,share_stdCWBCO2grossepo3;
    share_meanCWBCO2net, share_meanCWBCO2netepo1,share_meanCWBCO2netepo2,share_meanCWBCO2netepo3;share_stdCWBCO2net, share_stdCWBCO2netepo1,share_stdCWBCO2netepo2,share_stdCWBCO2netepo3];

CWB_global_expertbased_percent=CWB_global_expertbased.*100

%cd C:\..\IW_calculations % Choose the file path 
%writematrix(CWB_global_expertbased_percent,'CWB_global_expertbased.csv')
%writematrix(Factor,'social_discount_factor_expert.csv')

%colNames={'Total','Epo1','Epo2','Epo3'};
%rowNames={'Mean_gross','Std_gross','Mean_net','Std_nt'};

%CWB_global_expertbased_percent_table= array2table(CWB_global_expertbased_percent,'RowNames',rowNames,'VariableNames',colNames);
%writetable(CWB_global_expertbased_percent_table,'CWB_global_expertbased_table.csv','WriteVariableNames',true)
