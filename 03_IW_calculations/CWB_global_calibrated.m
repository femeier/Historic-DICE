...
Popmean=mean(Pop,2) %Note that it is not necessary to derive here mean since historical population dynamics are identical across scenarios
end
%% 3. PARAMETERS
rho_RMQ=4.4/100; %0.01950802;
eta_RMQ=1.2; %1.45;
for j=a1-1:a2-1
...
CWB_global_calib=[CCO2_acc_mean, CCO2_epo1_mean,CCO2_epo2_mean,CCO2_epo3_mean;
    CCO2_acc_std, CCO2_epo1_std,CCO2_epo2_std,CCO2_epo3_std; c18*[CCO2_acc_std, CCO2_epo1_std, CCO2_epo2_std, CCO2_epo3_std]];

CWB_global_calib_share=[share_meanCWBCO2gross, share_meanCWBCO2grossepo1,share_meanCWBCO2grossepo2,share_meanCWBCO2grossepo3;
...
CWB_global_calib_percent=CWB_global_calib_share.*100;

cd C:\..\IW_calculations % Choose the file path 
writematrix(CWB_global_calib,'CWB_global_calibrated.csv')
writematrix(CWB_global_calib_percent,'CWB_global_share_calibrated.csv')
writematrix(Factor,'social_discount_factor_calibrated.csv')

colNames={'Total','Epo1','Epo2','Epo3'};
rowNames={'Mean_gross','Std_gross','CI95_gross','Mean_net','Std_net','CI95_net'};
rowNames2={'Mean','Std','CI95'};

CWB_global_calib_table= array2table(CWB_global_calib,'RowNames',rowNames2,'VariableNames',colNames);
CWB_global_calib_share_table= array2table(CWB_global_calib_percent,'RowNames',rowNames,'VariableNames',colNames);

writetable(CWB_global_calib_table,'CWB_global_calib_table.csv','WriteRowNames',true,'WriteVariableNames',true)
writetable(CWB_global_calib_share_table,'CWB_global_share_calib_table.csv','WriteRowNames',true,'WriteVariableNames',true)
